                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="social-title pb30"
                                                                style="color:#ffffff; font-family: 'IBM Plex Sans', sans-serif; font-size:14px; line-height:22px; text-align:right; text-transform:uppercase; padding-bottom:30px;">
                                                                <div mc:edit="text_33"
                                                                    style="color: #333; direction: rtl !important;">

                                                                    <h3
                                                                        style="font-family: cairo, sans-serif; text-align: center;">
                                                                        السلام عليكم ورحمة الله وبركاتة
                                                                    </h3>

                                                                    <h3
                                                                        style="font-family: cairo, sans-serif; text-align: right;">
                                                                        يسعدنا تأكيد تسجيلكم فى اختبار
                                                                        {{ $test == 'duplicated' ? 'مكرر' : $test }}
                                                                        <br>في موعد
                                                                        {{ $appointment }} .
                                                                    </h3>
