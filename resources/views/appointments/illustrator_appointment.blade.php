          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{ route('add_appointment') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleInputappointment">إضافة موعد illustrator جديد</label>
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('appointmentExcel_ill') }}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
...
<script>
 function confirmDelete() {
            if (confirm("Are you sure you want to delete the table? This action cannot be undone.")) {
                window.location.href = "{{ route('deleteAppointment', ['confirmation' => true]) }}";
                return true ;
            }
            return false;
        }
