          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{ route('add_email') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail">إضافة بريد أكاديمي illustrator جديد</label>
                    ...
                    <div class="col-md-6">
                        <form action="import_ill_email" method="POST"  enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
            ...
            <h1> <b>البريد الأكاديمي illustrator</b></h1>
            <table class="table">
              ...
              @if($isTableNotEmpty)
                ...
                @if (isset($confirmation))
                    ...
                    <form method="post" action="{{ route('deleteTable') }}">
                        @csrf
...
<script>
 function confirmDelete() {
            if (confirm("Are you sure you want to delete the table? This action cannot be undone.")) {
                window.location.href = "{{ route('deleteTable', ['confirmation' => true]) }}";
            }
        }
        </script>
</body>
